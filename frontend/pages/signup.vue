...
<div class="flex justify-around h-screen mt-5">
    ...
    <div class="form justify-center md:justify-start items-center space-y-4 w-auto">
        ...
        <div class="space-y-5 justify-center">
            ...
            <div class="flex">
            <button class="ml-auto mr-auto md:ml-0 md:mr-0 w-5/6 sm:w-4/6 bg-sky-600 hover:bg-sky-700 px-10 py-2 rounded-full text-lg font-bold text-white">Sign Up</button>
            </div>
        </div>
